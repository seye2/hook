...
type StateChangeFunction<Item> = (state: DownshiftState<Item>) => Partial<StateChangeOptions<Item>>;
...
export interface PropGetters<Item> {
  getRootProps: (options?: GetRootPropsOptions, otherOptions?: GetPropsCommonOptions) => any;
...
export type DownshiftInterface<Item> = React.ComponentClass<DownshiftProps<Item>> & {
  stateChangeTypes: {
